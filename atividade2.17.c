...
void main () {
    int mes1=0, dia1=0,total1=0,total2=0,mes2=0,dia2=0 ;
    ...
    if (total1>total2) printf("A diferenca e de %d dias !",total1-total2);
    else printf("A diferenca e de %d dias !",total2-total1);
